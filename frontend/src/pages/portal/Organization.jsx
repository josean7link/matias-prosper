...
export default function PortalOrganization() {
  ...
  return (
    <div data-testid="portal-organization">
      ...
      {!org ? <div className="text-[#888]">No organization attached to your account yet.</div> : (
        <div className="prosper-card p-6">
          <div className="flex justify-between items-start mb-6">
            <div>
              <div className="text-[10px] uppercase tracking-wider text-[#888] font-mono">Organization</div>
              <h2 className="font-display font-bold text-2xl">{org.name}</h2>
              <div className="text-sm text-[#888] mt-1">{org.legal_name}</div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 tight-grid border border-[#1a1a1a]">
