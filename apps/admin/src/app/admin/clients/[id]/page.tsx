...
import AndesAccountTab from "./_tabs/AndesAccountTab";

type Tab = "info" | "users" | "kyb" | "andes" | "api_keys" | "webhooks" | "positions" | "transactions" | "compliance" | "audit";
const TABS: { id: Tab; label: string }[] = [
  { id: "info",         label: "Información" },
  { id: "users",        label: "Usuarios" },
  { id: "kyb",          label: "KYB docs" },
  { id: "andes",        label: "Cuenta Andes" },
  ...
  return (
    <div data-testid="admin-client-detail-page">
      ...
      <div>
        ...
        {tab === "andes"        && <AndesAccountTab orgId={orgId}/>}
