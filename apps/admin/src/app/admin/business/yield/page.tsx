    ...
    <div data-testid="biz-yield-page" className="space-y-6">
      <PageHeader
        breadcrumbs={[{ label: tA("breadcrumb_admin"), href: "/admin" },
                      ...
                      { label: tH("bus_yield_bc") }]}
        kicker={tH("bus_yield_kicker")}
        title={tH("bus_yield_title")}
        subtitle={tH("bus_yield_subtitle_tpl", { apr: swr.data?.platform_apr_pct ?? "—", bps: platformBps })}
        actions={
          <button
