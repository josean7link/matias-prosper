    ...
    <div data-testid="volume-by-client-page" className="space-y-6">
      <PageHeader
        breadcrumbs={[{ label: tA("breadcrumb_admin"), href: "/admin" },
                      ...
                      { label: tH("ops_volume_bc") }]}
        kicker={tH("ops_volume_kicker")}
        title={tH("ops_volume_title")}
        subtitle={tH("ops_volume_subtitle_tpl", { total: fmtMoney(swr.data?.total_volume_30d) })}
      />
