...
export function useBizClients(filters: { type?: string[]; status?: string[]; tier?: string[]; parent_org_id?: string } = {}) {
  ...
  if (filters.parent_org_id) p.set("parent_org_id", filters.parent_org_id);
