...
pytestmark = [
    ...
    pytest.mark.skip(
        reason="Legacy product catalog (liquid_v1/term_30/term_90/term_180) "
                  "deprecated by CMS protocol migration (Feb 2026). See "
                  "/app/backend/routes/client_invest.py DEFAULT_PRODUCTS."),
]
